    ...
    $(document).ready(function () {
        ...
        uiStorage.fullProject.change(function () {
            ...
            // Вмикаємо або вимикаємо інші чекбокси в залежності від стану fullProject
            uiStorage.measurements.prop("disabled", isChecked);
            uiStorage.replanning.prop("disabled", isChecked);
            uiStorage.furnitureSelection.prop("disabled", isChecked);
            uiStorage.visualization.prop("disabled", isChecked);
            uiStorage.drafts.prop("disabled", isChecked);
            uiStorage.estimate.prop("disabled", isChecked);
