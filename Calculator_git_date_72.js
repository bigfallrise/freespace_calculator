$(document).ready(function () {
    ...
    var calculate = function () {
        ...
        // Розрахунок ціни
        var pricearea = Math.min(Math.max(pricearea, 30), 500);
        ...
        var projectRevenue = (
            ...
            * (uiStorage.visualization.is(":checked") ? 1.0 : 0.0)
            + Math.min(3000, Math.max(400, pricearea * drafts))
            * (uiStorage.drafts.is(":checked") ? 1.0 : 0.0)
            + Math.min(1000, pricearea) * estimate
        ...
        * (uiStorage.supervision.is(":checked") ? 0.92 : 1.0);
        ...
        // Розрахунок терміну проекту
var projectDate = (
    Math.min(3, defaults.revenue + parseInt(uiStorage.areaOutput.html()) * (uiStorage.fullProject.is(":checked") ? 0.033333 : 0.0)) +
    Math.min(0.25, (parseInt(uiStorage.areaOutput.html()) * 0.033333) * (uiStorage.replanning.is(":checked") ? 0.15 : 0.0)) +
    Math.min(0.25, (Math.max(0.25, (parseInt(uiStorage.areaOutput.html()) * 0.0222222) * (uiStorage.furnitureSelection.is(":checked") ? 0.15 : 0.0))) * (uiStorage.furnitureSelection.is(":checked") ? 1.0 : 0.0)) 
    + Math.min(1, (Math.max(0.5, ((parseInt(uiStorage.areaOutput.html()) * 0.033333) * (uiStorage.visualization.is(":checked") ? 0.3 : 0.0)))) * (uiStorage.visualization.is(":checked") ? 1.0 : 0.0)) +
    Math.min(1, (Math.max(0.5, ((parseInt(uiStorage.areaOutput.html()) * 0.033333) * (uiStorage.drafts.is(":checked") ? 0.3 : 0.0)))) * (uiStorage.drafts.is(":checked") ? 1 : 0.0)) +
    Math.min(0.25, (parseInt(uiStorage.areaOutput.html()) * 0.033333) * (uiStorage.estimate.is(":checked") ? 0.1 : 0.0))
) * areaStyleMultiplier;
