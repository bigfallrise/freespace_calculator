        ...
        var calculate = function () {
            ...
            * (uiStorage.supervision.is(":checked") ? 0.92 : 1.0);
            ...
            var projectDate = (defaults.revenue +
                Number.parseInt(uiStorage.areaOutput.html()) 
                * 0.022222)
                * (uiStorage.fullProject.is(":checked") ? 1.00 : 0.0)
                + Number.parseInt(uiStorage.areaOutput.html()) 
            ...
            * 0.040;
            ...
            uiStorage.projectDate.html((Math.round10(projectDate))+"міс");
            uiStorage.repaireDate.html((Math.round10(repaireDate))+"міс");
        };
