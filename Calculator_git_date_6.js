    ...
    $(document).ready(function () {
        ...
        var calculate = function () {
            ...
            var supervision = uiStorage.supervision.is(":checked") ? 250 : 1.0;
            ...
            Number.parseInt(uiStorage.areaOutput.html()) * (uiStorage.fullProject.is(":checked") ? 500 : 0.0)
            *(uiStorage.supervision.is(":checked") ? 0.9 : 1.0);


            // Розрахунок терміну проекту
            var projectDate = defaults.revenue +
                Number.parseInt(uiStorage.areaOutput.html()) * (uiStorage.fullProject.is(":checked") ? 0.03333 : 0.0);


            // Розрахунок терміну ремонту
            var repaireDate = defaults.revenue +
            Number.parseInt(uiStorage.areaOutput.html()) * (uiStorage.fullProject.is(":checked") ? 0.06666 : 0.0);
            ...
            uiStorage.projectDate.html((Math.round(projectDate))+"міс");
