...
$(document).ready(function () {
    ...
    $("#sendButton").on("click", function() {
        ...
        var dataToSend = {
            input1: $("#input1").val(),
            input2: $("#input2").val(),
            // і так далі, додаємо всі потрібні дані
        };

        // Виконуємо AJAX-запит для відправки даних
        $.ajax({
            url: "ваш_URL_для_відправки",
            type: "POST", // або "GET", в залежності від вашого випадку
            data: dataToSend,
            success: function(response) {
                // Обробляємо успішну відповідь тут
