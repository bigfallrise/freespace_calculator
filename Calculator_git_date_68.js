    ...
    var calculate = function () {
        ...
        var projectRevenue = (
            ...
            * (uiStorage.fullProject.is(":checked") ? 1.0 : 0.0)
            + Math.max(200, parseInt(uiStorage.areaOutput.html()) * replanning)
            * (uiStorage.replanning.is(":checked") ? 1.0 : 0.0)
            + parseInt(uiStorage.areaOutput.html()) * furnitureSelection
            + Math.max(400, parseInt(uiStorage.areaOutput.html()) * visualization)
            * (uiStorage.visualization.is(":checked") ? 1.0 : 0.0)
            + Math.max(400, parseInt(uiStorage.areaOutput.html()) * drafts)
            * (uiStorage.drafts.is(":checked") ? 1.0 : 0.0)
            + parseInt(uiStorage.areaOutput.html()) * estimate
